...
class _ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    ...
    Firestore.instance
        ...
        .updateData({'chattingWith': displayId});
        ...
        children: <Widget>[
          Text(
            DateFormat('dd MMM kk:mm')
                .format(DateTime.fromMicrosecondsSinceEpoch(int.parse(time))),
            style: TextStyle(
              fontSize: 12.0,
          ...
          type == 0
              ? Material(
                  ...
                  elevation: 5.0,
                  color:
                      isMe ? Color(0xFF162447).withOpacity(0.8) : Colors.white,
                  child: Padding(
                    padding:
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: isMe
                            ? Colors.white
                            : Color(0xFF162447).withOpacity(0.8),
                        fontSize: 15.0,
                      ),
                    ),
                  ),
